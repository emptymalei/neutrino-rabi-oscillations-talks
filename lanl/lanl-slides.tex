...
Oscillation frequency in matter: 
...
\caption*{
Lines: Rabi formula\\
Dots, diamonds, triangles, and squares are {\bf full solutions without approximations} for $k=\omega_{\mathrm m}$, $k=(1-2\times 10^{-5})\omega_{\mathrm m}$, and $k=(1-10^{-4})\omega_{\mathrm m}$ respectively.
}
\end{figure}
...
\caption*{Width of different modes}
\end{figure}
