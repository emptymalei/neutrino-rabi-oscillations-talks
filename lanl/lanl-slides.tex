...
\date{\small January 31, 2017}
%\today}
\author{Lei Ma\\
%{\bf{Supervisor}}: Huaiyu Duan
in collaboration with \\
Huaiyu Duan, and Shashank Shalgar
}
...
\begin{textblock*}{100pt}(130pt,230pt)
\centering
\small DOE EPSCoR grant\\ \#DE-SC0008142
\end{textblock*}


\begin{textblock*}{100pt}(260pt,210pt)
\includegraphics[height=1.5cm]{Los_Alamos_logo.png}
\end{textblock*}

\begin{textblock*}{100pt}(10pt,210pt)
\includegraphics[height=1.5cm]{University_of_New_Mexico_Seal.png}
\end{textblock*}
...
\begin{figure}
    ...
    \caption*{Turbulence in supernova. E. Borriello, et al  (2014)}
...
%stimulated-neutrino-oscillations-kneller.png}
\caption*{
Transition between two mass states in background matter potential $\lambda_0$\\
Lines: Rabi formula\\
...
\subsection{Rabi Oscillations With Multiple Driving Frequencies}
...
Consider the resonance condition ($k=\omega_{\mathrm m}$) 
...
\begin{equation*}
\mathbf{\widetilde H}\sim -\frac{\omega_{\mathrm m}}{2}\sigma_3 + \frac{1}{2}  \begin{pmatrix}
0 &  \alpha_{1} e^{i   k x}\\
  \alpha_{1}^* e^{ -i   k x} & 0
\end{pmatrix} +  \frac{1}{2}\begin{pmatrix}
0 &  \alpha_{n} e^{i   n k  x}\\
  \alpha_{n}^* e^{ -i   n k  x} & 0
\end{pmatrix}
\end{equation*}
...
\vspace{40pt}
\begin{equation*}
D' =  \left\vert \frac{\alpha_2^2}{2 \alpha_n(\omega_{\mathrm m}-n k)} \right\vert
\end{equation*}
...
\begin{table}
%\caption{$k=\omega_{\mathrm m}$}
\begin{tabular}{ c  c c }
\multicolumn{2}{c}{$k=\omega_{\mathrm m}$} \\
\hline\hline
$n$ & $D'$ & Amplitude \\
\hline
1 & $0$ & $1$ \\
1 \& -1 & $4.8\times 10^{-6}$ & $1-2.3\times 10^{-11}$ \\
1 \& 2 & $2.1\times 10^{-14}$ & $1-4.4\times 10^{-28}$ \\
1 \& -2 & $6.9\times 10^{-15}$ & $1-4.8\times 10^{-29}$
\end{tabular}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.7\textwidth]{assets/modified-relative-detuning-single-frequency}
% \end{figure}
...
\begin{equation*}
\alpha_n =  - (-i)^n  n  k \tan 2\theta_{\mathrm{m}}  J_n ( A \cos 2\theta_{\mathrm{m}} / k )
\end{equation*}
...
\begin{equation*}
    \lvert \alpha_n \rvert \propto  \sqrt{\frac{n}{2\pi}} \left( \frac{ e A\cos 2\theta_{\mathrm m} }{2 n k} \right)^n  , \quad \text{for large } n
\end{equation*}
...
\begin{tcolorbox}
{\bf Width} drops fast at large $n$.\\
But the critical value for each mode becomes larger for large $n$'s
\begin{equation*}
    \alpha_{n,\mathrm C}\equiv\sqrt{ 2 \lvert \alpha_1 (n k - \omega_{\mathrm m}) \rvert }
\end{equation*}
...
\caption*{Width of different modes given value of matter potential frequency $k$}
\end{figure}
...
\begin{equation*}
    J_n(n \sech \beta) \sim \frac{ e^{ - n(\beta -\tanh\beta )} }{ \sqrt{ 2\pi n \tanh \beta } }, \quad \text{for large } n
\end{equation*}
...
\begin{equation*}
    \lvert \alpha_n \rvert \propto  \frac{ e^{ - n ( \beta - \tanh \beta )} }{\sqrt{2\pi n \tanh \beta} } , \quad \text{for large } n
\end{equation*}

where $\sech\beta = A\cos 2\theta_{\mathrm{m}}/\omega_{\mathrm m}$.
...
\begin{tcolorbox}
$\beta-\tanh\beta > 0$ $\Rightarrow$ {\bf Width} drops fast at large $n$.
\end{tcolorbox}
