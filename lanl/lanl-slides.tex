...
\begin{equation*}
    \mathbf H = - \frac{\vec \sigma}{2}\cdot \vec H
\end{equation*}
...
\begin{align*}
-\frac{\omega_{\mathrm v} }{2}\boldsymbol{ \sigma_3 } = \begin{pmatrix}
0\\
0\\
\omega_{\mathrm v}
\end{pmatrix}
...
=& \cos 2\theta_{\mathrm v}\begin{pmatrix}
0\\
0\\
\omega_{\mathrm v}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{assets/flavor-isospin-2}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{assets/flavor-isospin-1}
\end{figure}
...
\begin{align*}
    &n_e(x) = n_0 + \delta n(x) \\
    \Rightarrow & \lambda(x) = \lambda_0 + \delta \lambda(x)
\end{align*}
\end{tcolorbox}
...
\begin{textblock*}{10pt}(270pt,1pt)
\small
\begin{equation*}
...
\begin{textblock*}{10pt}(170pt,-1pt)
{\tiny
\begin{equation*}
\vec H = \begin{pmatrix}
    0\\
